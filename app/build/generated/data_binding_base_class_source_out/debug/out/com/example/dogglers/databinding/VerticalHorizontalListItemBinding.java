...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView dogeHobby;

  @NonNull
  public final AppCompatImageView imageDog;

  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView dogAge, @NonNull TextView dogName, @NonNull TextView dogeHobby,
      @NonNull AppCompatImageView imageDog) {
    this.rootView = rootView;
    this.dogAge = dogAge;
    this.dogName = dogName;
    this.dogeHobby = dogeHobby;
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.doge_hobby;
      TextView dogeHobby = rootView.findViewById(id);
      if (dogeHobby == null) {
        break missingId;
      }

      id = R.id.image_dog;
      AppCompatImageView imageDog = rootView.findViewById(id);
      if (imageDog == null) {
        break missingId;
      }

      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, dogAge, dogName,
          dogeHobby, imageDog);
    }
